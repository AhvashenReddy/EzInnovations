  ...
  return (
    <section id="about" className="section-padding bg-gray-50" aria-labelledby="about-heading">
      <div className="section-container">
        ...
        >
          <h2 id="about-heading" className="heading-secondary mb-6">
        ...
        >
          {stats.map((stat, index) => (
            <motion.div
              ...
              className="card-modern p-8 text-center card-hover group"
            >
              <div className="w-16 h-16 bg-gradient-to-r from-teal-600 to-cyan-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-start space-x-4">
                  <div className="w-6 h-6 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-full flex items-center justify-center mt-1 flex-shrink-0">
